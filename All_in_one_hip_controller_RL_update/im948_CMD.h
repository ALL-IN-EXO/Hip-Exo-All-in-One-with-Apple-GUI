...
extern U8 BattLeftPct, BattRightPct, Batt1Pct, Batt2Pct, Batt3Pct, Batt4Pct; // 电量百分比[0-100], 255=未知
...
extern void Cmd_10_Left(void);   // 获取左腿 IMU 设备属性和状态
extern void Cmd_10_Right(void);  // 获取右腿 IMU 设备属性和状态
extern void Cmd_10_1(void);      // 获取 IMU1 设备属性和状态
extern void Cmd_10_2(void);      // 获取 IMU2 设备属性和状态
extern void Cmd_10_3(void);      // 获取 IMU3 设备属性和状态
extern void Cmd_10_4(void);      // 获取 IMU4 设备属性和状态
/**
 * 设置设备参数
